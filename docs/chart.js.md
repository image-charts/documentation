...
Image Charts is compatible with Chart.js You can put your Chart.js definition directly in URL like : `https://image-charts.com/chart.js/2.8.0?c={"type": "bar","data": {"labels": ["January","February","March"],"datasets": [{"data": [-31,-70,-30]}]},"options": {"legend": {"display": false}}}`
...
JSON/Javascript definition of the chart. Use [Chart.js configuration](https://www.chartjs.org/docs/latest/charts/) 

**You should URL-encore your chart definition**
