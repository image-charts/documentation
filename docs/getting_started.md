...
- **`chd=t:60,40`** The chart data. This data is in simple text format, but [there are other formats](#data-format).
- **`chl=Hello|World`** The slice labels.
- **`chan`** [Animate the chart](#chart-gif-animation), renders a gif
