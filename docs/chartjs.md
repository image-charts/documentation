...
Image Charts is compatible with Chart.js You can put your Chart.js definition directly in URL like : `https://localhost:8080/chart.js/2.8.0?c={"type": "bar","data": {"labels": ["January","February","March"],"datasets": [{"data": [-31,-70,-30]}]},"options": {"legend": {"display": false}}}`
